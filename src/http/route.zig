    ...
    fn method_to_index(method: Method) !u32 {
        return switch (method) {
            ...
            .PATCH => 8,
                ...
                log.debug("unsupported HTTP method: {any}", .{method});
